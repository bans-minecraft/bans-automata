...
local HBox = require("lib.widget.container.hbox")
local VBox = require("lib.widget.container.vbox")
...
local ReactorModel = Class("ReactorModel")

function ReactorModel:init(settings, reactor)
  self.settings = settings
  self.reactor = reactor
end

function ReactorModel:step()
end
...
local function main(args)
  ...
  local vbox = VBox:new()
  local hbox = HBox:new()
  local foo = Label:new("Foo", colors.red, colors.pink)
  local bar = Label:new("Bar", colors.blue, colors.gray)
  local baz = Label:new("Baz", colors.black, colors.cyan)

  vbox:addChild(foo, "start", true, true)
  vbox:addChild(bar, "start", true, true)
  hbox:addChild(vbox, "start", true, true)
  hbox:addChild(baz, "start", true, true)
